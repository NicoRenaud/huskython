...
system.add_electrode_xyz('./elec1.xyz',trans=[0,0,-7.06])
system.add_electrode_xyz('./elec2.xyz',trans=[0,0,+7.06])
...
plt.semilogy(trans.energies,trans.junction.electrodes['0'].nprop_channel)
